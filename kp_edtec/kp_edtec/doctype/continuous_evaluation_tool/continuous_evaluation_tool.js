...
frappe.ui.form.on('Continuous Evaluation Tool', {
	refresh:function(frm){
		frm.disable_save();
			...
			frappe.call({
				method: "kp_edtec.kp_edtec.doctype.continuous_evaluation_tool.continuous_evaluation_tool.make_continuous_evaluation",
				args: {
	...
	setup: function(frm) {
		...
		frm.set_query('course', function() {
			return {
				query: 'kp_edtec.kp_edtec.doctype.continuous_evaluation_tool.continuous_evaluation_tool.get_courses',
				// 'kp_edtec.kp_edtec.doctype.program_enrollment.get_program_courses',
				// 'erpnext.education.doctype.program_enrollment.program_enrollment.get_program_courses',
				filters: {
