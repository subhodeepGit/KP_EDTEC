...
frappe.ui.form.on('Assessment Credits Allocation', {
	setup: function(frm) {
		...
		frm.set_query("course", function() {
			return {
				query: 'kp_edtec.kp_edtec.doctype.assessment_credits_allocation.assessment_credits_allocation.get_courses',
				filters: {
		...
		frm.set_query("assessment_criteria", function() {
			return {
				query: 'kp_edtec.kp_edtec.doctype.assessment_credits_allocation.assessment_credits_allocation.get_assessment_criteria',
				filters: {
	...
	get_assessments:function(frm){
		if(frm.doc.assessment_criteria){
			frappe.call({
				method:"kp_edtec.kp_edtec.doctype.assessment_credits_allocation.assessment_credits_allocation.get_course_assessment",
				args: {
					student:frm.doc.student,
					course:frm.doc.course,
