...
frappe.ui.form.on('Hostel Allotment', {
	setup:function(frm){
		...
		frm.set_query("student", function() {
			return {
				query: 'kp_edtec.ed_tec.doctype.hostel_allotment.hostel_allotment.get_hostel_students',
				filters:{
					"hostel_admission":1
				}
			};
		...
		frm.set_query("to_room", function() {
			return {
				query: 'kp_edtec.ed_tec.doctype.hostel_allotment.hostel_allotment.get_rooms',
			    filters: {
