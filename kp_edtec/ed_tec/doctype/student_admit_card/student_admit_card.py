...
from kp_edtec.ed_tec.doctype.workspace import create_workspace
...
# bench execute ed_tec.ed_tec.doctype.student_admit_card.student_admit_card.create_admit_card
