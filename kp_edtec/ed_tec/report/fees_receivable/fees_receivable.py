...
class ReceivablePayableReport(object):
	...
	def prepare_conditions(self):
		conditions = [""]
		values = [self.filters.report_date,]
		# party_type_field = scrub(self.party_type)

		self.add_common_filters(conditions,values)
	...
	def get_order_by_condition(self):
		if self.filters.get('group_by_student'):
			return "order by student, posting_date"
		else:
			return "order by posting_date, student"

	def add_common_filters(self, conditions, values):
	...
	def get_columns(self):
		...
		self.add_column(label=_("Student"), fieldname='student',
			fieldtype='Link', options="Student", width=180)

		# if self.party_naming_by == "Naming Series":
		self.add_column(label=_('Student Name'),
			fieldname = 'student_name', fieldtype='Data')

		# if self.party_type == 'Customer':
		self.add_column(_("Student Contact"), fieldname='student_primary_contact',
			fieldtype='Link', options='Contact')

		# self.add_column(label=_('Cost Center'), fieldname='cost_center', fieldtype='Data')
		# self.add_column(label=_('Voucher Type'), fieldname='voucher_type', fieldtype='Data')
		self.add_column(label=_('Fees'), fieldname='fees', fieldtype='Link',
			options='Fees', width=180)
		self.add_column(label='Due Date', fieldtype='Date', fieldname='due_date')
		...
		if self.filters.based_on_payment_terms:
			...
			self.add_column(label=_('Fees Grand Total'), fieldname='grand_total', fieldtype='Float')

		# self.add_column(_('Fees Amount'), fieldname='fees_amount', fieldtype='Float')
		self.add_column(_('Paid Amount'), fieldname='paid_amount', fieldtype='Float')
		# if self.party_type == "Customer":
		# 	self.add_column(_('Credit Note'), fieldname='credit_note')
		# else:
			# note: fieldname is still `credit_note`
			# self.add_column(_('Debit Note'), fieldname='credit_note')
		self.add_column(_('Outstanding Amount'), fieldname='outstanding_amount', fieldtype='Float')
		...
		# 	self.add_column(label=_('Customer LPO'), fieldname='po_no', fieldtype='Data')
			...
			# 	options='Territory')
			self.add_column(label=_('Student Group'), fieldname='student_group', fieldtype='Link',
