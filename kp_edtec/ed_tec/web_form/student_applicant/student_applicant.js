frappe.ready(function() {
	frappe.web_form.after_load = () => {
	    ...
	    frappe.web_form.on('academic_year', (field, value) => {
			if(value){
				frappe.call({
					method: "kp_edtec.ed_tec.web_form.student_applicant.student_applicant.get_academic_term",
					args:{
                        'academic_year':value
					},
					callback: function(r) {
		...
		frappe.web_form.on('tribe', (field, value) => {
			if(value){
				frappe.call({
					method: "kp_edtec.ed_tec.web_form.student_applicant.student_applicant.get_sub_tribe",
					args:{
						'tribe':value
					},
					callback: function(r) {
		...
		frappe.web_form.on('sub_tribe', (field, value) => {
			if(value){
				frappe.call({
					method: "kp_edtec.ed_tec.web_form.student_applicant.student_applicant.get_sub_tribe_name",
					args:{
						'name':value
					},
					callback: function(r) {
		...
		frappe.web_form.on('states', (field, value) => {
			if(value){
				frappe.call({
					method: "kp_edtec.ed_tec.web_form.student_applicant.student_applicant.get_phone_code",
					args:{
						'states':value
					},
					callback: function(r) {
		...
		frappe.web_form.on('student_category', (field, value) => {
			if(value){
				frappe.call({
					method: "kp_edtec.ed_tec.web_form.student_applicant.student_applicant.get_document_list",
		            args:{
		...
		frappe.call({
			method: "kp_edtec.ed_tec.web_form.student_applicant.student_applicant.get_department",
			callback: function(r) {
			    frappe.web_form.fields_dict.department._data = create_dict(r.message);
			}
		});
		frappe.call({
			method: "kp_edtec.ed_tec.web_form.student_applicant.student_applicant.get_qualification_list",
            callback: function(r) {
		...
		frappe.web_form.on('program_choice_1', (field, value) => {
			if(value){
				frappe.call({
					method: "kp_edtec.ed_tec.web_form.student_applicant.student_applicant.get_counselling_structure",
					args:{
						'programs':value
					},
					callback: function(r) {
	...
	let filter_program_choice = function(){
		if(frappe.web_form.get_value('department') && frappe.web_form.get_value('program_grade')){
			frappe.call({
				method: "kp_edtec.ed_tec.web_form.student_applicant.student_applicant.get_programs_list",
				args:{
