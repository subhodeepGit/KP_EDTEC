frappe.ready(function() {
	...
	frappe.web_form.after_load = () => {
		...
		frappe.web_form.on('student_category', (field, value) => {
			if(value){
				frappe.call({
					method: "kp_edtec.ed_tec.web_form.student_exchange_applicant.student_exchange_applicant.get_document_list",
		            args:{
		...
		frappe.call({
			method: "kp_edtec.ed_tec.web_form.student_exchange_applicant.student_exchange_applicant.get_guardian_list",
            callback: function(r) {
            	frappe.web_form.fields_dict.guardians.grid.fields_map.guardian_.options = r.message;
            }
        });
        frappe.call({
			method: "kp_edtec.ed_tec.web_form.student_exchange_applicant.student_exchange_applicant.get_qualification_list",
            callback: function(r) {
